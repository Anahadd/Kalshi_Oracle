...
export function SiteFooter() {
  ...
  return (
    <footer ref={ref} className="w-full py-16 px-6 border-t border-white/10">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          >
            <div className="flex items-center mb-4">
              <svg className="w-[78px] h-[20px] text-white" viewBox="0 0 78 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-white/50 text-sm max-w-md leading-relaxed mb-6">
              The world&apos;s first legal prediction market platform. Trade on the outcome of events 
              and see how often the market gets it right.
            </p>
          ...
          >
            <h4 className="text-white/40 text-xs font-bold tracking-wider uppercase mb-4">
              Explore
            </h4>
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/called-it" className="text-white/70 text-sm hover:text-white transition-colors">
                  Gallery
                </Link>
              </li>
              <li>
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row items-center justify-between gap-4 mt-16 pt-8 border-t border-white/5"
        >
          <p className="text-white/30 text-xs text-center md:text-left">
            Kalshi is regulated by the CFTC. Prediction markets are not investment advice.
          </p>
          <div className="flex items-center gap-6">
            <a href="https://kalshi.com/privacy" target="_blank" rel="noopener noreferrer" className="text-white/30 text-xs hover:text-white/50 transition-colors">
              Privacy Policy
            </a>
            <a href="https://kalshi.com/terms" target="_blank" rel="noopener noreferrer" className="text-white/30 text-xs hover:text-white/50 transition-colors">
              Terms of Service
            </a>
          </div>
        </motion.div>
